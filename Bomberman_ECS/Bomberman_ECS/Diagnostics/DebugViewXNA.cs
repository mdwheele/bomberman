...
namespace Bomberman_ECS.Diagnostics
{
#if DEBUG
    /// <summary>
    ...
    public class DebugViewXNA : DebugView, IDisposable
    {
        ...
        //Debug panel
#if XBOX
        public Vector2 DebugPanelPosition = new Vector2(355, 100);
#else
        public Vector2 DebugPanelPosition = new Vector2(340, 100);
#endif
        private int _max;
        private int _avg;
        private int _min;
...
#if XBOX
        public Rectangle PerformancePanelBounds = new Rectangle(565, 100, 200, 100);
#else
        public Rectangle PerformancePanelBounds = new Rectangle(550, 100, 200, 100);
#endif
